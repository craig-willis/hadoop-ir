...
/**
 * Convert a set of files from TREC-text format to Hadoop sequence file
 * Sequence files are used as input into the Mahout kmeans and LDA implementations.
 */
public class TrecToSequence extends Configured implements Tool 
{
	...
	public int run(String[] args) throws Exception 
	{
		...
		job.setJarByClass(TrecToSequence.class);
	...
	{
		ToolRunner.run(new Configuration(), new TrecToSequence(), args);
	}
}
